...
public class OrderRepository {
    ...
    public static final StaticTableSchema<Submission> SUBMISSION_STATIC_TABLE_SCHEMA = StaticTableSchema.builder(Submission.class)
            ...
            .addAttribute(String.class, a -> a.name("referral")
                    .getter(Submission::getReferral)
                    .setter(Submission::setReferral))
            .addAttribute(String.class, a -> a.name("eventDate")
                    .getter(Submission::getEventDate)
                    .setter(Submission::setEventDate))
            .addAttribute(String.class, a -> a.name("venue")
                    .getter(Submission::getVenue)
                    .setter(Submission::setVenue))
